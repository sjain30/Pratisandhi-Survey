...
class SectionThree : Fragment(R.layout.fragment_section_three) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.nextThree.setOnClickListener {
            ...
            viewModel.updateSurvey3(radio1.text.toString(), q20, q21, radio2.text.toString(), radio3.text.toString(), q24, radio4.text.toString(), q26,
                radio5.text.toString(), binding.editText8.editText?.text.toString(), radio6.text.toString(), radio7.text.toString(), radio8.text.toString())
        }
